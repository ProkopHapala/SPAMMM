"""
MMparams.py — Force field parameter parsing for MMFF and UFF.
...
Key functionality:
  ...
  - MMFFparams — full MMFF parameter database (atoms, bonds, angles, torsions, vdw)
...
and MMFF.py (MMFF force field setup). All parameter files live in data/.
"""
