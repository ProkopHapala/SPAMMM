...
| `azaindol_draw_demo/` | `./run_gui.sh --script demos/gui_scripts/azaindol_draw_demo.py` | Live GUI PNG frames + `azaindol_draw_demo.gif` |
| `azaindol_draw_offline/` | `PYTHONPATH=. python demos/gui_scripts/azaindol_draw_offline.py` | Headless SVG (+PNG) draw frames |
