...
//
// Provides kernels for assembling multi-molecule configurations from rigid-body
// transforms and evaluating steric clashes (packing quality).
//
// Kernels:
//   - emit_configuration_xyz: Apply rigid-body transforms to base molecule, producing assembled multi-molecule system (1 thread = 1 atom)
//   - evaluate_packing_3d: Evaluate steric overlap/clash between molecules in a 3D periodic arrangement, with early exit on severe clashes
//
// Self-contained (no dependency on common.cl or Forces.cl).
