...
// === AUTO-DOC BEGIN ===
// @file PME.cl
// @brief Full Pauli Master Equation STM kernel — 4 sites / 16 states (hardcoded).
// Tip multipole+mirror+ramp → site E/T; workgroup Gauss–Jordan → P, I.
// Identical to FireCore/ppafm copies (md5). Tip μ = v_tips[pixel].
// === AUTO-DOC END ===
