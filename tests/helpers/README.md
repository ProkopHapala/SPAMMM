...
| `topology_test.py` | `TopologySnapshot`, `TopologyDiff`, `render_before_after` for editing tests |
| `review.py` | `ReviewSession`, `.out`/`.log` writers for L1 agent review (`make_review` fixture) |
