---
type: Task
title: Static rigid molecules and combined PairFF+FAF 2D probe map in SPAMMM_GUI (original plan)
status: implemented — all 16 review findings (F1–F16) addressed; 3 USER-reported regressions fixed; EventEmitter loop resolved; 23 L0 tests pass. See ../Reports/StaticObstacle_DragDemo_2026-08-03.md §7–§8 for details.
tags: [GUI, rigid-body, PairFF, FAF, OpenCL, visualization, drag, mixed-species]
timestamp: 2026-08-03
related: [MultiMol_FAF_ConcurrentRelax.md, PairFF_FAF_Substrate.md, PairFF_MultiBody_Kernel.md, PairFF_MapDisplay_SSOT.md, RigidMoleculePose_SSOT.md, ../Reports/StaticObstacle_DragDemo_2026-08-03.md, RigidAssembly_StaticMols_PotentialMap.md]
