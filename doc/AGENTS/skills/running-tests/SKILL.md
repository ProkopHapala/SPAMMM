...
The SPAMMM test system follows the design in `doc/TEST_DESIGN.md`. Scripts in `tests/` fall into **three classes**:
...
- May use existing plotting functions from `spammm/SPM/AFM_utils.py` and `spammm/SPM/AFM.py`
