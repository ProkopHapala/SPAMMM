...
**Planned / task-backed:** site-resolved Pauli maps (`doc/Tasks/Pauli_A_beta_KrigingTransferability.md`); Kekulé RI density (`doc/Tasks/Kekule_ExponentialDensityFit.md`); 2.5D contact-surface finish (`doc/Tasks/Fast_2p5D_AFM_ContactSurface.md`).
