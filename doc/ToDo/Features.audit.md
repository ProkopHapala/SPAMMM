...
| `GUI/RigidBodyVispy.py` + `demos/demo_pairff.py` | ✅ Active | Demo / headless | PairFF Vispy: FIRE ON, click-to-select, `--mols`, `--faf` map + `potential_to_rgba` display SSOT — [PairFF_manual.md](../../demos/PairFF_manual.md); tip-pull offline maps pending [PairFF_MapDisplay_SSOT.md](../Tasks/PairFF_MapDisplay_SSOT.md) |
