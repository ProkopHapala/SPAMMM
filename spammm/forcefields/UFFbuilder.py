"""
UFFbuilder.py — UFF system builder: from AtomicSystem to UFF topology arrays.

Purpose: Convert an AtomicSystem (or loaded molecule) into UFF-compatible topology
arrays: atom types, bond list, angle list, torsion list, inversion list, and
neighbor data. Assigns UFF parameters from ElementTypes.dat.

Key functionality:
  - UFF_Builder: main builder class (from mol2/xyz files or AtomicSystem)
  - Atom type assignment by element and hybridization
...
class UFF_Builder:
    ...
    def __init__(self, mol, bSimple=False, b141=False, bConj=False, bCumulene=False):
        ...
        self.params = mmparams.SPFFparams(data_path)
