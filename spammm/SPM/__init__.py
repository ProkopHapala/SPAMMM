...
with disk caching in **ModularPipeline.py**. Manipulation path optimization
via evolutionary algorithms in **ManipulationPathOpt.py**. Trajectory generators
for scan patterns in **ScanUtils.py**.
"""
