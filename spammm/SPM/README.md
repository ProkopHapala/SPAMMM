...
- **AFM_utils.py** — Tip densities (`pad_mode='cpu'|'none'`), FDBM orchestration, STM/orbital helpers (`project_mo_xy_slice`, `project_mo_stm_sk_slice`, `plot_spectrum_with_orbitals`).
