"""
dftb_utils.py — DFTB+ integration utilities for SPAMMM.

Purpose: Wrapper and helper functions for running DFTB+ calculations via subprocess
or the C-API. Handles input generation, output parsing, and SK parameter management.
...
Python workflow with the DFTB+ Fortran/C executable.
"""
