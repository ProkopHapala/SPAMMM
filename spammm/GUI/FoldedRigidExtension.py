...
def build_ui(window):
    ...
    g_main.add(window.fr_load_fit_btn, span=2)
    ...
    g_main.add(window.fr_run_btn, span=2)
    ...
    g_main.add(window.fr_step_btn, span=2)
    layout.addLayout(g_main.layout())

    # COM / drag spring
    g_pos = GridPlacer(cols=8)
    ...
    g_pos.add_pair("x:", window.fr_x_spin, label_span=1, input_span=1)
    ...
    g_pos.add_pair("y:", window.fr_y_spin, label_span=1, input_span=1)
    ...
    g_pos.add_pair("z:", window.fr_z_spin, label_span=1, input_span=1)
    ...
    g_pos.add_pair("k:", window.fr_k_spring_spin, label_span=1, input_span=1)
    layout.addLayout(g_pos.layout())

    # Dynamics parameters
    g_dyn = GridPlacer(cols=10)
    ...
    g_dyn.add_pair("n_iter:", window.fr_niter_spin, label_span=1, input_span=1)
    ...
    g_dyn.add_pair("dt:", window.fr_dt_spin, label_span=1, input_span=1)
    ...
    g_dyn.add_pair("Fconv:", window.fr_fconv_spin, label_span=1, input_span=1)
    ...
    g_dyn.add_pair("ld:", window.fr_lin_damp_spin, label_span=1, input_span=1)
    ...
    g_dyn.add_pair("ad:", window.fr_ang_damp_spin, label_span=1, input_span=1)
    layout.addLayout(g_dyn.layout())

    # Overlay / energy
    g_ov = GridPlacer(cols=6)
    ...
    g_ov.add(window.fr_show_substrate_chk, span=3)
    ...
    g_ov.add(window.fr_show_potential_chk, span=3)
    layout.addLayout(g_ov.layout())

    # Potential slice controls
    g_pot = GridPlacer(cols=6)
    ...
    g_pot.add_pair("type:", window.fr_potential_type_combo, label_span=1, input_span=2)
    ...
    g_pot.add_pair("span:", window.fr_potential_span_spin, label_span=1, input_span=1)
    ...
    g_pot.add_pair("n:", window.fr_potential_n_spin, label_span=1, input_span=1)
    layout.addLayout(g_pot.layout())

    # Slice buttons
    g_slice = GridPlacer(cols=6)
    ...
    g_slice.add(window.fr_xz_slice_btn, span=3)
    ...
    g_slice.add(window.fr_yz_slice_btn, span=3)
    ...
    g_fit.add_pair("nu:", window.fr_nu_spin, label_span=1, input_span=1)
    ...
    g_fit.add_pair("nv:", window.fr_nv_spin, label_span=1, input_span=1)
    ...
    g_fit.add_pair("α:", window.fr_alpha_spin, label_span=1, input_span=2)
    adv_layout.addLayout(g_fit.layout())

    # Fit z range
    g_zr = GridPlacer(cols=6)
    ...
    g_zr.add(window.fr_zmin_spin, span=1)
    g_zr.add(QtWidgets.QLabel("-"), span=1)
    g_zr.add(window.fr_zmax_spin, span=1)
    adv_layout.addLayout(g_zr.layout())

    # Advanced action buttons
    g_adv_btn = GridPlacer(cols=6)
    ...
    g_adv_btn.add(window.fr_fit_btn, span=2)
    ...
    g_adv_btn.add(window.fr_save_fit_btn, span=2)
    adv_layout.addLayout(g_adv_btn.layout())

    # Scan parameters
    g_scan = GridPlacer(cols=6)
    ...
    g_scan.add_pair("span:", window.fr_scan_span_spin, label_span=1, input_span=1)
    ...
    g_scan.add_pair("n:", window.fr_scan_n_spin, label_span=1, input_span=1)
    ...
    g_scan.add_pair("scan z:", window.fr_z_scan_spin, label_span=1, input_span=2)
    adv_layout.addLayout(g_scan.layout())

    # Scan buttons
    g_scan_btn = GridPlacer(cols=6)
    ...
    g_scan_btn.add(window.fr_lat_scan_btn, span=3)
    ...
    g_scan_btn.add(window.fr_relaxed_scan_btn, span=3)
