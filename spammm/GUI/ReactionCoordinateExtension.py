...
def build_ui(window):
    ...
    row_hb.addWidget(window.rc_refresh_hb_btn)
    window.rc_hbond_spin = QtWidgets.QSpinBox()
    window.rc_hbond_spin.setMinimum(0)
    window.rc_hbond_spin.setMaximum(99)
    row_hb.addWidget(QtWidgets.QLabel("pair"))
    row_hb.addWidget(window.rc_hbond_spin)
    ...
    row_opts.addWidget(window.rc_relax_endpoints_chk)
    row_opts.addStretch()
    layout.addLayout(row_opts)

    row_dx = QtWidgets.QHBoxLayout()
    row_dx.addWidget(QtWidgets.QLabel("dx:"))
    ...
    row_run.addWidget(window.rc_run_btn)
    ...
    row_esp.addWidget(window.rc_esp_z_spin)
    row_esp.addWidget(QtWidgets.QLabel("grid:"))
    ...
    row_esp.addWidget(window.rc_esp_n_spin)
    ...
    row_esp.addWidget(window.rc_esp_btn)
    row_esp.addStretch()
